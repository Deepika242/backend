...
exports.getAllPokemons = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching Pokemon", error: error.message });
  }
};
...
exports.deletePokemon = async (req, res) => {
  try {
    ...
    pokemonList = pokemonList.filter(
      (user) => user.pokemonOwnerName !== ownerName
    );
    ...
    res
      .status(500)
      .json({ message: "Error deleting Pokemon user", error: error.message });
  }
};
...
exports.deleteAllPokemons = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Error deleting all Pokemon users",
        error: error.message,
      });
  }
};
...
exports.addPokemon = async (req, res) => {
  try {
    ...
    let ownerIndex = pokemonList.findIndex(
      (entry) => entry.pokemonOwnerName === newPokemon.pokemonOwnerName
    );
    ...
    res
      .status(500)
      .json({ message: "Error adding Pokemon", error: error.message });
  }
};
...
exports.addPokemonToUser = async (req, res) => {
  try {
    ...
    const ownerIndex = pokemonList.findIndex(
      (user) => user.pokemonOwnerName === ownerName
    );
    if (ownerIndex === -1) {
    ...
    res
      .status(500)
      .json({ message: "Error adding Pokemon to user", error: error.message });
  }
};
...
exports.getAllPokemonOwners = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching Pokemon owners", error: error.message });
  }
};
...
exports.getPokemonByOwner = async (req, res) => {
  try {
    ...
    const ownerData = pokemonList.find(
      (entry) => entry.pokemonOwnerName === ownerName
    );
    ...
    res
      .status(500)
      .json({
        message: "Error fetching Pokemon by owner",
        error: error.message,
      });
  }
};
...
exports.getPokemonByOwnerAndUpdate = async (req, res) => {
  try {
    ...
    const ownerIndex = pokemonList.findIndex(
      (entry) => entry.pokemonOwnerName === pokemonOwnerName
    );
    ...
    res
      .status(500)
      .json({
        message: "Error updating Pokemon owner data",
        error: error.message,
      });
  }
};
